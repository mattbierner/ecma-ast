...
(SourcePosition.prototype.increment = (function(tok) {
    var self = this;
    return ((tok === "\n") ? new(SourcePosition)((self.line + 1), 0, self.file) : new(SourcePosition)(self.line, (
        self.column + 1), self.file));
}));
...
(SourceLocation.merge = (function(s1, s2) {
    return new(SourceLocation)(s1.file, ((s1.start.compare(s2.start) > 0) ? s2.start : s1.start), ((s1.end.compare(
