...
var __o = require("./node"),
    ...
    Expression, ThisExpression, SequenceExpression, UnaryExpression, BinaryExpression, AssignmentExpression,
        UpdateExpression, LogicalExpression, ConditionalExpression, NewExpression, CallExpression, MemberExpression,
...
(SequenceExpression = defineNode(Expression, "SequenceExpression", ["expressions"], [], (function(loc, expressions) {
    var self = this;
    Node.call(self, loc);
...
(UpdateExpression = defineNode(Expression, "UpdateExpression", ["argument"], ["operator", "prefix"], (function(loc,
